...
export function playDrumSound(drumType) {
    ...
    if (this.samples[drumType]) {
        try {
            ...
            if (this.effectsProcessor && this.effectsProcessor.inputGain) {
                console.log('🥁 Routing drum through effects processor');
                finalNode.connect(this.effectsProcessor.inputGain);
            } else {
